...
def call_clean_merge_grdata(specific_year):
    ...
    #define headers to use in API call below
    headers2 = {'Accept': 'application/json','API_KEY': '540EDE9D-46C4-48C5-9D76-91D06C061520'}
    ...
    def pull_commodities():
        ...
        commodities = requests.get("https://apps.fas.usda.gov/PSDOnlineDataServices/api/LookupData/GetCommodities",headers = headers2).json()
    ...
    def clean_psd_filter_gr_os(psd2):
        ...
        atts_IDs_api = requests.get('https://apps.fas.usda.gov/OpenData/api/psd/commodityAttributes', headers=headers2).json()
        ...
        unit_IDs_api = requests.get('https://apps.fas.usda.gov/OpenData/api/psd/unitsOfMeasure', headers=headers2).json()
...
gr_data.to_excel("/Users/aina/Desktop/gr_data_Nov2022.xlsx")
...
#export the merged gr_data to excel
os_data.to_excel("/Users/aina/Desktop/os_data_082322.xlsx")
